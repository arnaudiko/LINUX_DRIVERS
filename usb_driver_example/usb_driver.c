...
*  \author     CodeurPro
*
*  \Tested with kernel 5.4.0-56-generic
*
*******************************************************************************/
...
#define USB_VENDOR_ID       ( 0x0D50 )      //USB device's vendor ID
#define USB_PRODUCT_ID      ( 0x0008 )      //USB device's product ID
